<?php
/**
 * Aquatiq - Panel Padre: Ver detalle de evaluación
 */
...
// Obtener evaluación verificando que el hijo pertenece al padre
$stmt = $pdo->prepare("
    SELECT e.*, 
    ...
    WHERE e.id = ? AND a.padre_id = ?
");
$stmt->execute([$evaluacion_id, $user['id']]);
...
<div class="page-header">
    <h1>
        <a href="/padre/evaluaciones.php?hijo=<?= $evaluacion['alumno_id'] ?>" style="color: var(--gray-400); margin-right: 0.5rem;">←</a>
        Evaluación
    </h1>
</div>
